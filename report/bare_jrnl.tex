...
\author{Juan~Diego~Lizarazo,~Sergio~Alejandro~López% <-this % stops a space
  \\
...
% The paper headers
\markboth{Informe Técnico - Sistema de Gestión de Finanzas Personales,~Mayo~2025}%
